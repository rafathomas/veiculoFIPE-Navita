...
async function loadReferencia() {
    try {
        const {
            data
        } = await axios.post(`${fipeAPI}/ConsultarTabelaDeReferencia`);
...
async function loadMarcas() {
    try {
        ...
        const {
            data
        } = await axios.post(`${fipeAPI}/ConsultarMarcas`, form);
...
async function loadAnos() {
    try {
        ...
        const {
            data
        } = await axios.post(`${fipeAPI}/ConsultarAnoModelo`, form);
...
function renderVeiculo(data) {
    ...
    ${
      ...
      `
        <br>
        <select id="historico" style="display: none;">
          <option value="" style="display: none;">Escolha o ano para exibir a variação de preço.</option>
